...
| Category | Skills |
|------------------------------------|------------------------------------|
| **Cloud Platforms** | Azure (ML, Databricks, Data Factory), Hadoop, Spark, Hive, Cloudera |
| **LLM & Deep Learning** | BERT, T5, RNN (LSTM), CNN, GAN, RAG, Prompt Engineering, TensorFlow, PyTorch, MLflow |
| **Machine Learning** | Classification, Regression, Clustering, Forecasting, Anomaly Detection |
...
-   Deployed NLP pipeline using Transformer models on Azure Databricks analyzing 2M+ job ads.
-   Built RAG system to match skills with qualifications — improving match accuracy by 40%.
